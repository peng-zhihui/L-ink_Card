...
static const uint32_t KL28Z_FLM[] = {
...
static const program_target_t flash = {
    ...
    // RSP : Initial stack pointer
    {
        ...
        0x20000000 + 0x20 + 0x624,  // static base register value (image start + header + static base offset)
    ...
    sizeof(KL28Z_FLM), // algo_size, size of array above
    KL28Z_FLM,  // image, flash algo instruction array
    512        // program_buffer_size, largest size that can be written in a single call to program page
};
